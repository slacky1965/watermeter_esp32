...
void mqtt_init() {
    ...
    sprintf(topic_water[hot_in],
            DELIM MQTT_TOPIC "/%02X%02X%02X%02X%02X%02X/" END_TOPIC_HOT_IN,
            MAC2STR(mac));
    sprintf(topic_water[cold_in],
            DELIM MQTT_TOPIC "/%02X%02X%02X%02X%02X%02X/" END_TOPIC_COLD_IN,
            MAC2STR(mac));
    sprintf(topic_water[hot_out],
            DELIM MQTT_TOPIC "/%02X%02X%02X%02X%02X%02X/" END_TOPIC_HOT_OUT,
            MAC2STR(mac));
    sprintf(topic_water[cold_out],
            DELIM MQTT_TOPIC "/%02X%02X%02X%02X%02X%02X/" END_TOPIC_COLD_OUT,
            MAC2STR(mac));
    sprintf(topic_water[control],
            DELIM MQTT_TOPIC "/%02X%02X%02X%02X%02X%02X/" END_TOPIC_CONTROL,
            MAC2STR(mac));
